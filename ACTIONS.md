...
- [ ] **Game-smoke met echte BIOS** — Christian levert `o2rom.bin` (md5 562d5ebf9e030a40d6fabfc2f33139fd) aan; dan `tools/g7k_run --bios ... --cart vp_14.bin` + browser-test met Gunfighter/Thunderball/vp_01pl (26-07)
